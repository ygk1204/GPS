    ...
    <div>
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <%--<div>
                        <input id="hmreqid" readonly="readonly" name="gpshmrequest._HMREQID" value="<%= Model.gpshmrequest._HMREQID %>"class="form-control" />
                    </div>--%>
                </td>
                <th>상태</th>
                <td>
                    ...
                    <%--<div>
                        <input id="status" readonly="readonly" name="gpshmrequest._STATUS" value="<%= Model.gpshmrequest._STATUS%>"class="form-control" />
                    </div>--%>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <%--<div>
                        <input id="requestdate" readonly="readonly" name="gpshmrequest._REQUESTDATE" value="<%= Model.gpshmrequest._REQUESTDATE%>"class="form-control" />
                    </div>--%>
                </td>
                <th>요청자 사번</th>
                <td>
                    <%= Model.gpshmrequest._REQUESTUSERID %>
                    <%--<div>
                        <input id="requestuserid" readonly="readonly" name="gpshmrequest._REQUESTUSERID" value="<%= Model.gpshmrequest._REQUESTUSERID %>" class="form-control" />
                    </div>--%>
                </td>
            </tr>
            <tr>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <th>항목</th>
                <td>
                    <input id="hazardousmaterialtype" readonly="readonly" name="hazardousmaterialtype"
                        value="<%=Model.gpshmrequest._HAZARDOUSMATERIALTYPE%>" class="form-control" />
                </td>
                <th>
                    Lead Time
                </th>
                <td>
                    <input id="description" readonly="readonly" name="categoryinfo._DESCRIPTION" value="<%= Model.categoryinfo._DESCRIPTION %>"
                        class="form-control " />
                </td>
            </tr>
        </table>
                ...
                <td>
                    <div class="handout_file">
                        <table class="handout_file">
                            <%for (int i = 0; i < Model.lstFileHandOut.Count; i++)
                              {%>
                            <%if (Model.lstFileHandOut[i]._FILENAME != null)
                              {%>
                            <tr>
                                <td>
                                    <div>
                                        <a class="downloadfile" href='javascript:void(0);' onclick="downloadfile(this);">
                                            <%=Model.lstFileHandOut[i]._FILENAME%></a>
                                        <input type="hidden" name="physicalfilename" class="physicalfilename" value="<%=Model.lstFileHandOut[i]._PHYSICALFILENAME%>" />
                                        <input type="hidden" name="filename" class="filename" value="<%=Model.lstFileHandOut[i]._FILENAME%>" />
                                        <input type="hidden" name="physicalfilelocation" class="physicalfilelocation" value="<%=Model.lstFileHandOut[i]._PHYSICALFILELOCATION%>" />
                                    </div>
                                </td>
                            </tr>
                            <%}  }%>
