...
{
    public class NoCache2 : ActionFilterAttribute
    {
        ...
        public ActionResult LogOn(LogOnModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                if (MembershipService.ValidateUser(model.UserName, model.Password))
                {
                    ...
                    string UserRole = GetAuthority(model.UserName);
                    Session["Authority"] = UserRole;  
                ...
                {
                    return RedirectToAction("error_login", "Return");
                }
            }
